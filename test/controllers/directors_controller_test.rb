...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { birthday: @director.birthday, first_name: @director.first_name, last_name: @director.last_name }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { birthday: @director.birthday, first_name: @director.first_name, last_name: @director.last_name }
    assert_redirected_to director_path(assigns(:director))
  end
